...
\begin{align}
  \mathrm{Var}(XY) &=\mathbb{E}(X^2Y^2)-\mathbb{E}^2(XY) \\
          &= \mathbb{E}(X^2)\mathbb{E}(Y^2) + \mathrm{Cov}(X^2,Y^2)-[\mathbb{E}(X)\mathbb{E}(Y) + \mathrm{Cov}(X,Y)]^2.
  (\#eq:varprod)
\end{align}
...
\begin{align}
  \mathrm{Var}(XY)&= \mathbb{E}(X^2)\mathbb{E}(Y^2) -[\mathbb{E}(X)\mathbb{E}(Y)]^2 \\
         &= [\mathrm{Var}(X)+\mathbb{E}(X)^2][\mathrm{Var}(Y)+\mathbb{E}(Y)^2] - [\mathbb{E}(X)E(Y)]^2 \\
         &= \mathrm{Var}(X)\mathrm{Var}(Y) + E(X)^2\mathrm{Var}(Y) + E(Y)^2\mathrm{Var}(X).
  (\#eq:varprodind)
\end{align}
