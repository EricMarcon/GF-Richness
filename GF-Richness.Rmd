...
We applied the same method to our data (**Appendix**).
...
The relation between Sorensen's similarity and distance is shown in figure *n
...
## Log-series estimation of the number of species
