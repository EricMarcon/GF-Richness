...
37 more species at the Cayenne herbarium [CAY: @Hoff1989] were collected in the area but outside the plots.
...
It encompasses four 1-ha and one half-hectare plots in GuyaDiv and a few small plots added for various studies.
...
Nouragues research station [@Bongers2001] provides 22 hectares of permanent plots curated the same way Paracou's in a common network called Guyafor.
We applied the same protocol, adding Guyadiv plots and herbarium collections up to `r NOU_S` species in a `r NOU_envelope`-km^2^ area.
